...
namespace Log
{
	namespace Receiver
	{
		...
		protected:
			...
			//virtual void onContextCreate(const Logger::ContextLogger* newContext) = 0;
			...
			//virtual void onContextDestroy(const Logger::ContextLogger* loggerToDestroy) = 0;
			//virtual void onContextDelete(Logger::AbstractLogger* loggerToDestroy) = 0;
